...
class DataCenter:
    ...
    def get_apis(time_option: int) -> Dict[str, Dict[str, Any]]:
        ...
        # API配置模板
        api_templates = {
            '车辆销售明细表_订单日期': {'url': f'{Config.API_BASE_URL}/api/Summary/CarSalDetailSummary','method': 'GET','payload': {"TimeType": 1,"Type": 2,"PageSize": Config.PAGE_SIZE,"PageNumber": 1,**time_params}},
            ...
            '装饰_订单管理_装饰订单': {'url': f'{Config.API_BASE_URL}/api/Summary/AccessoryOrder','method': 'GET','payload': {"LikeType": "1","TimeType": "2","PageSize": 500,"PageNumber": 1,**time_params}},
            ...
            '销售_衍生_订单查询': {'url': f'{Config.API_BASE_URL}/api/Summary/SalePreorder','method': 'GET','payload': {"TimeType": "1","LikeType": "3","PageSize": 500,"PageNumber": 1,**time_params}},
            ...
            '未售订单': {'url': f'{Config.API_BASE_URL}/api/Summary/UnSaleCar','method': 'GET','payload': {'DateType': '1',"timetype": "1","LikeType": "3","PageSize": Config.PAGE_SIZE,"PageNumber": 1,**time_params}},
            '计划车辆': {'url': f'{Config.API_BASE_URL}/api/Summary/PurchaseOrder','method': 'GET','payload': {"OrderState": "1","PageSize": Config.PAGE_SIZE,"PageNumber": 1,**time_params}},
            '库存车辆查询': {'url': f'{Config.API_BASE_URL}/api/Summary/StoreCar','method': 'GET','payload': {"OrgType": "0","TimeType": "3","ShowPriceFlag": "1","PageSize": Config.PAGE_SIZE,"PageNumber": 1,**time_params}},
        }
